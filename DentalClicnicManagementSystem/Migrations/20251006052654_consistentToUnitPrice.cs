...
{
    /// <inheritdoc />
    public partial class consistentToUnitPrice : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 49,
                column: "Date",
                value: new DateTime(2025, 9, 20, 0, 0, 0, 0, DateTimeKind.Local));
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 55,
                column: "Date",
                value: new DateTime(2025, 9, 18, 0, 0, 0, 0, DateTimeKind.Local));
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 61,
                column: "Date",
                value: new DateTime(2025, 9, 16, 0, 0, 0, 0, DateTimeKind.Local));
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 64,
                column: "Date",
                value: new DateTime(2025, 9, 15, 0, 0, 0, 0, DateTimeKind.Local));
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "IsCombinedInvoice = 1");

            migrationBuilder.AddCheckConstraint(
                name: "CK_Invoices_OneTypeOnly",
                table: "Invoices",
                sql: "(CASE WHEN IsMedicationInvoice = 1 THEN 1 ELSE 0 END) + (CASE WHEN IsAppointmentInvoice = 1 THEN 1 ELSE 0 END) + (CASE WHEN IsCombinedInvoice = 1 THEN 1 ELSE 0 END) <= 1");
